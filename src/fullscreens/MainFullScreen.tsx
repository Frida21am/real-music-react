    ...
    <div className="fullscreen">
      <div className="container">
        <div className="fulscreen-caption">
          ...
          <div className="fulscreen-caption__btn" onClick={() => setIsPopupOpen(true)}>
            <span>Получить консультацию</span>
          </div>
        </div>
      </div>
      <FeedbackFormPopup isPopupOpen={isPopupOpen} onPopupClosing={setIsPopupOpen} />
    </div>
  )
}

function FeedbackFormPopup(props: { isPopupOpen: boolean; onPopupClosing: (isPopupOpen: boolean) => void }) {
  return (
    <div className="feedback-popup">
      ...
      ></div>
      <div className={props.isPopupOpen ? "popup__content showed" : "popup__content"}>
        <div className="popup-form">
          <form action="#" className="popup-form-contacts">
            <span className="popup__close" onClick={() => props.onPopupClosing(false)}>
              <img src="/close.png" alt="" />
            </span>
            <div className="popup__title">Мы перезвоним вам в ближайшее время</div>
            ...
            <div className="popup-form-contacts__bottom">
              ...
              <div className="popup-form-contacts__confidentiality">Мы гарантируем конфиденциальность данных</div>
            </div>
          </form>
        </div>
      </div>
