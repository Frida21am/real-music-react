...
function DeliveryStages() {
  return (
    <div className="delivery-stages">
      ...
      >
        <motion.div custom={1} variants={animationStages} className="delivery-stages__item">
        ...
        <motion.div custom={2} variants={animationStages} className="delivery-stages__item">
        ...
        <motion.div custom={3} variants={animationStages} className="delivery-stages__item">
        ...
        <motion.div custom={4} variants={animationStages} className="delivery-stages__item">
